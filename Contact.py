# address information gathering programming.
...
def main():
    ...
    kim.print_info()
'''
# input address data -menu option 1
def set_contact():
    name = input("Name: ")
...
def print_contract(contact_list):
